...
public class PersonMain {
    ...
    public static void main(String[] args, LocalDate dateOfBirth) {
        ...
        Person person = new Person(personFirstName, personLastName, dateOfBirth);
        ...
        RegisteredPerson registeredPerson = new RegisteredPerson(registeredPersonFirstName, registeredPersonLastName, dateOfBirth, registeredPersonGovID);
        ...
        RegisteredPerson newRegisteredPerson = new RegisteredPerson(person, dateOfBirth, newRegisteredPersonGovID);
