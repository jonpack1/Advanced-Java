 ...
 * OCCC - ADVANCED JAVA
 * DATE: 05 20, 2024
 * PROJECT NAME: BaseConversion.java
 * DESCRIPTION:
 */
...
public class BaseConversion {
    public static void main(String args[]) {
        ...
        if (args.length == 3) {
            ...
            input.close();
            // Check the value against the initial base and continue if true.
            if (isValidInteger(value, initialBase) == true) {
                String convertedNum = convertInteger(value, initialBase, finalBase);
    ...
    public static String convertInteger(String value, int initialBase, int finalBase) {
        String finalValue;
    ...
    public static String convertFromBaseTen(BigInteger baseTenValue, int finalBase) {
        // Not sure if StringBuilder was necessary here but I wanted to try it out.
